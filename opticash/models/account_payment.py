...
class account_payment(models.Model):
    ...
    def _create_expense_entry(self, expense_lines, tax_line_ids):
        ...
        for line in expense_lines:
            ...
            counterpart_aml_dict.update({'name': line.name, 'currency_id': currency_id, 'account_id': line.account_id.id, 'analytic_account_id': line.account_analytic_id.id, 'analytic_tag_ids':[(6, 0, [tag.id for tag in line.analytic_tag_ids])]})
            ...
            if self.payment_difference_handling == 'reconcile' and self.payment_difference:
                ...
                writeoff_line['analytic_tag_ids'] = [(6, 0, [tag.id for tag in line.analytic_tag_ids])]
